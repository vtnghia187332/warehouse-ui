<template>
    <div class="bg-white radius-shadow_add">
        <div class="p-3 flex items-center justify-between">
            ...
            <el-button class="bg-slate-500" type="primary" :disabled="disabled" v-show="isShowButton" @click="visible = true">{{
                buttonLabel
            }}</el-button>
        </div>
        <div v-if="item" class="p-3 flex items-center justify-between border-t border-neutral-1">
            ...
            <el-button class="bg-slate-500" type="primary" :disabled="disabled" v-show="isShowButton"
                @click="visible = true">delete</el-button>
        </div>
